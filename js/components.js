...
function renderNav(active = '') {
  ...
  <nav class="navbar">
    <a href="${base}index.html" class="nav-logo">
      <img src="${base}logo.png" alt="JohnyRose Agrospring Rwanda Ltd" style="height:52px;width:auto;"/>
      <div style="margin-left:.6rem;line-height:1.25">
        <div style="font-family:'Playfair Display',serif;font-size:1.15rem;font-weight:700;color:#0f2818;letter-spacing:-.01em">JohnyRose Agrospring</div>
        <div style="font-size:.78rem;color:#1a5c2e;font-weight:700;letter-spacing:.02em">Rwanda Limited</div>
      </div>
    </a>
    <ul class="nav-links">
